						...
						switch ( type ) {
							case GET:
								if ( method.isAnnotationPresent( WebSocketGet.class ) ) {
									WebSocketGet get = method.getAnnotation( WebSocketGet.class );
							...
							case SUBSCRIBE:
								if ( method.isAnnotationPresent( WebSocketSubscribe.class ) ) {
									WebSocketSubscribe subscribe = method.getAnnotation( WebSocketSubscribe.class );
							...
							case UNSUBSCRIBE:
								if ( method.isAnnotationPresent( WebSocketUnSubscribe.class ) ) {
									WebSocketUnSubscribe unSubscribe = method.getAnnotation( WebSocketUnSubscribe.class );
